...
const Item = ({id,name,image,price}) => {
  return (
    <div className=''>
      ...
      <Link to={`/product/${id}`} onClick={window.scroll(0 , 0)} className='h-7 w-40 bg-secondary bg-opacity-85 rounded-lg flexCenter absolute top-1/2 !py-2 z-20 scale-0 group-hover:scale-100 transition-all duration-700'>
